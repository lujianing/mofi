...
<body>
	...
	<form name="form1" method="post" action="updateStateAll?state=pass">
        ...
        <tr>
          <td width="140"><label>
            <div align="right">提交完成信息：</div>
          </label></td>
          <td width="119"><label>
            <input type="submit" name="Submit" value="提交选中项">
          </label></td>
          <td width="213"><a href="ExportToExcelU?type=pass">导出Excel</a>（请在D盘下查找）</td>
        </tr>
      </table>
...
　　　　		<% }else{%>
　　　　		 
　　　　　　		<a href="listPassApplyInfo?page=1">第一页</a>  
　　　　　　		<a href="listPassApplyInfo?page=<%=pagebean.getCurrentPage()-1 %>">上一页</a>  
　　　　		<% }%> 
　　　　		<% if(pagebean.getCurrentPage() != pagebean.getTotalPage()){ %>
　　　　　　	<a href="listPassApplyInfo?page=<%=pagebean.getCurrentPage()+1 %>">下一页</a>  
　　　　　　	<a href="listPassApplyInfo?page=<%=pagebean.getTotalPage() %>"/>最后一页</a>  
　　　　		<% }else{%>  
　　　　		  
　　　　　　		下一页 最后一页  
　　　　		<%} %>
