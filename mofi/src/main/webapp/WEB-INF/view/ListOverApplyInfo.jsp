...
<body>
	...
	<form name="form1" method="post" action="updateStateAll?state=pass">
        ...
        <tr>
          ...
          <td width="213"><a href="ExportToExcelU?type=over">导出Excel</a>（请在D盘下查找）</td>
        </tr>
      </table>
...
　　　　		<% }else{%>
　　　　		 
　　　　　　		<a href="listOverApplyInfo?page=1">第一页</a>  
　　　　　　		<a href="listOverApplyInfo?page=<%=pagebean.getCurrentPage()-1 %>">上一页</a>  
　　　　		<% }%> 
　　　　		<% if(pagebean.getCurrentPage() != pagebean.getTotalPage()){ %>
　　　　　　	<a href="listOverApplyInfo?page=<%=pagebean.getCurrentPage()+1 %>">下一页</a>  
　　　　　　	<a href="listOverApplyInfo?page=<%=pagebean.getTotalPage() %>"/>最后一页</a>  
　　　　		<% }else{%>  
　　　　		  
　　　　　　		下一页 最后一页  
　　　　		<%} %>
